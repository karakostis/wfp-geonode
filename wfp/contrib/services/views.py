...
from models import Service, Layer, ServiceLayer, WebServiceHarvestLayersJob, WebServiceRegistrationJob
from geonode.security.views import _perms_info
from geonode.utils import bbox_to_wkt, json_response
from geonode.security.enumerations import AUTHENTICATED_USERS, ANONYMOUS_USERS
from forms import CreateServiceForm, ServiceLayerFormSet, ServiceForm
...
from utils import llbbox_to_mercator, mercator_to_llbbox, http_client
...
def _register_arcgis_layers(service, arc=None, owner=None):
    """
...
def _process_arcgis_service(arcserver, owner=None, parent=None):
    ...
    if settings.USE_QUEUE:
        ...
        _register_arcgis_layers(service, arc=arcserver, owner=owner)
