...
MAP_BASELAYERS = [{
    ...
    #"args":[ "Open Street Map", ["http://a.tile.openstreetmap.org/${z}/${x}/${y}.png"],
...
#http://github.com/ckan/ckan/blob/2052628c4a450078d58fb26bd6dc239f3cc68c3e/ckan/logic/action/create.py#L43
CKAN_ORIGINS = [{
