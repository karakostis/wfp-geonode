...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.identifier'
        db.add_column(u'base_license', 'identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'License.abbreviation'
        db.add_column(u'base_license', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResourceBase.polymorphic_ctype'
        db.add_column(u'base_resourcebase', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_base.resourcebase_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'ResourceBase.popular_count'
        db.add_column(u'base_resourcebase', 'popular_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ResourceBase.share_count'
        db.add_column(u'base_resourcebase', 'share_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ResourceBase.featured'
        db.add_column(u'base_resourcebase', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ResourceBase.thumbnail'
        db.alter_column(u'base_resourcebase', 'thumbnail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Thumbnail'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'License.identifier'
        db.delete_column(u'base_license', 'identifier')

        # Deleting field 'License.abbreviation'
        db.delete_column(u'base_license', 'abbreviation')

        # Deleting field 'ResourceBase.polymorphic_ctype'
        db.delete_column(u'base_resourcebase', 'polymorphic_ctype_id')

        # Deleting field 'ResourceBase.popular_count'
        db.delete_column(u'base_resourcebase', 'popular_count')

        # Deleting field 'ResourceBase.share_count'
        db.delete_column(u'base_resourcebase', 'share_count')

        # Deleting field 'ResourceBase.featured'
        db.delete_column(u'base_resourcebase', 'featured')


        # Changing field 'ResourceBase.thumbnail'
        db.alter_column(u'base_resourcebase', 'thumbnail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Thumbnail'], null=True))
    ...
    models = {
        ...
        u'base.resourcebase': {
            ...
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Thumbnail']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
