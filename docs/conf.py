...
project = u'WFP GeoNode'
copyright = u'2013, UN World Food Programme'
...
version = '0.1' #app.get_version()
# The full version, including alpha/beta/rc tags.
release = '0.1' #app.get_version()
...
htmlhelp_basename = 'wfpdjangoprojecttemplate'
...
latex_documents = [
    ('index', 'WFPDjangoProjectTemplate.tex', u"WFP Django Project Template Documentation",
...
man_pages = [
    ('index', 'wfpdjangoprojecttemplate', u"WFP Django Project Template Documentation",
